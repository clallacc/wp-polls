        ...
        case __('Edit Poll', 'wp-polls'):
            ...
            if($get_polla_aids) {
                ...
                foreach($polla_aids as $polla_aid) {
                    ...
                    $polla_images = $_POST['polla_images_'.$polla_aid];
                    $edit_poll_answer = $wpdb->update(
                        $wpdb->pollsa,
                        array(
                            'polla_answers' => $polla_answers,
                            'polla_images' => $polla_images,
            ...
            if(!empty($polla_answers_new)) {
                ...
                $polla_image = $_POST['polla_images_'.$i];
...
switch($mode) {
    ...
    case 'edit':
        ...
        $poll_answers = $wpdb->get_results( $wpdb->prepare( "SELECT polla_aid, polla_answers, polla_images, polla_votes FROM $wpdb->pollsa WHERE polla_qid = %d ORDER BY polla_aid ASC", $poll_id ) );
                    ...
                    <?php
                        ...
                        if($poll_answers) {
                            ...
                            foreach($poll_answers as $poll_answer) {
                                ...
                                $polla_image = $poll_answer->polla_images;
                                ...
                                echo "<td class=\"td-poll-answer\" width=\"60%\"><input type=\"text\" size=\"50\" maxlength=\"200\" name=\"polla_aid-$polla_aid\" value=\"". esc_attr( $polla_answers ) . "\" />&nbsp;&nbsp;&nbsp;";
                                echo image_button($polla_aid, $polla_image);
